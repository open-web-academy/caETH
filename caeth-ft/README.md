Chain Abstraction ETH (caETH) Fungible Token Smart Contract
===================
caETH modification for
Based on the example implementation of a [Fungible Token] contract which uses [near-contract-standards] and [simulation] tests. This is a contract-only example.
